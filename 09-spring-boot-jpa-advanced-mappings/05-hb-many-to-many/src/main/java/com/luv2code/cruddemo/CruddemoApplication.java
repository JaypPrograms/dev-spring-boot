...
//			deleteCourse(appDAO);
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		tempStudent.addCourse(new Course("Database Management"));
		tempStudent.addCourse(new Course("Object Oriented Programming"));
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		Course tempCourse=new Course("Software engineering");

		Student jayperson =new Student("jayperson",
				"Babaran", "jayperson@gmail.com");
		Student mike =new Student("Mike",
				"Chan", "mike@gmail.com");

		tempCourse.addStudent(jayperson);
		tempCourse.addStudent(mike);
	...
	private void createCourseAndReviews(AppDAO appDAO) {
		...
		Course tempCourse = new Course("computer programming 1");

		tempCourse.addReview(new Review("This is a nice subject"));
		tempCourse.addReview(new Review("This is a awesome subject"));
		tempCourse.addReview(new Review("This is a fantastic subject"));
